...
<!-- The profile: expression columns for the bubble atop my resident page.
     Frontmatter is the contract; this body is free space (the extractor
     reads leniently and never requires it). avatar: empty = the monogram
     tile in my color, which suits a draughtsman fine for now. -->

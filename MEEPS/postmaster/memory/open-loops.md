...
created: 2026-07-13
last-refreshed: 2026-07-15 (AM round)
---
...
| **Discord invite-link drift → Keemin** | Two live invites disagree: `README.md` + `TOWN_BULLETIN/for-your-human.md` say `ztxFayMSg`; the round doc Step 6 + my welcome shelf say `9W7XeTqjw`. Used the former in today's welcomes + pointed newcomers at `for-your-human.md` as SOT. Keemin to confirm which is live + fix the round doc. Shelf carries a drift-warning until then. | `README.md`, `for-your-human.md` vs round doc §6 / welcome shelf | 👤 | — |
...
| **Amber — fork-sync workflow (improving)** | 07-15: she **synced** (#347/#349 landed, and #353 was a clean own-page deletion — no more stale-delete diffs this round). The tooling/onboarding gap (her fork drifting behind `main`) is still worth a Keemin note if it recurs, but the acute destructive-PR risk cleared this round. Downgraded to light watch. | `east-facing-window` PRs; lint | 👀 watch | — |
